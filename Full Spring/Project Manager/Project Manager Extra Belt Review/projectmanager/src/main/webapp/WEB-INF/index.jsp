...
<body style="font-family:cursive;margin-left:30%">
...
<form:form action="/register" method="post" modelAttribute="newUser">
	...
	<table>
	    ...
	    <thead>
	        ...
	        <tr>
	        	<td colspan=2><input class="btn btn-primary" class="input" class="button" type="submit" value="Submit"/></td>
	        </tr>
	    </thead>
	</table>
</form:form>
