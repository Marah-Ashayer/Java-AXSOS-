...
<div style="display:flex;margin-left : 15%;margin-bottom:50px;margin-top : 30px">
	...
	<form:form action="/projects/new" method="post" modelAttribute="project"  style="width : 400px;margin-left : 15%;">
	  ...
	  <div class="form-group">
	    ...
	    <form:input path= "description" type="text" class="form-control" id="exampleInputPassword1" placeholder="Description"></form:input>
	  </div>
	  <div class="form-group">
	    <form:label path="dueDate" for="exampleInputPassword1">Due Date:</form:label>
	    <form:errors path="dueDate"/>
	    <form:input path="dueDate" type="date" class="form-control" id="exampleInputPassword1"></form:input>
	  </div>
